...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    if (!loading && user?.emailVerified) router.push(user.occupationRole ? "/dashboard/projects" : "/flow")
  ...
  const handleSubmit = useCallback(async (e?: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => router.push(user?.occupationRole ? "/dashboard/projects" : "/flow"), 1200)
    } catch (err: unknown) {
