      ...
      <aside ref={asideRef} className="relative hidden lg:flex flex-col justify-between overflow-hidden bg-linear-to-br from-blue-600 via-blue-600 to-blue-700 text-white px-12 py-12 rounded-r-[2.5rem]">
        ...
        <div className="relative z-10">
          <h2 className="aside-headline text-4xl xl:text-5xl font-bold leading-tight tracking-tight">
            Start ranking.<br />Start winning.
          </h2>
          <p className="aside-subtitle mt-4 text-blue-100 max-w-md">
            Join thousands of SEOs who track their rankings for free — no credit card, no limits that matter.
          </p>
        </div>
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="grid grid-cols-3 gap-6 pt-6 border-t border-white/20">
            <div className="aside-stat">
              ...
              <p className="text-xs text-blue-100 mt-1">Forever plan</p>
            </div>
            <div className="aside-stat">
              <p className="text-2xl font-bold">190+</p>
              <p className="text-xs text-blue-100 mt-1">Countries</p>
            </div>
            <div className="aside-stat">
              <p className="text-2xl font-bold">5 min</p>
              <p className="text-xs text-blue-100 mt-1">To first result</p>
            </div>
          </div>
        </div>
      </aside>
        ...
        <div ref={containerRef} className="flex-1 flex items-center justify-center mt-10 lg:mt-0">
          <div className="w-full max-w-md">
            <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 uppercase tracking-wider">
              <span className="text-blue-500">★</span> Free forever
            </span>
            ...
            {keyword ? (
              <p className="mt-2 text-slate-500">
                Set up in under 2 minutes to analyze{" "}
                <span className="text-blue-600 font-medium">&ldquo;{keyword}&rdquo;</span>.
              </p>
            ) : (
              <p className="mt-2 text-slate-500">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div className="field-row flex items-start gap-3">
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  I agree to the{" "}
                  <Link href="#" className="text-blue-600 font-medium hover:text-blue-700">Terms of Service</Link>
                  {" "}and{" "}
                  <Link href="#" className="text-blue-600 font-medium hover:text-blue-700">Privacy Policy</Link>
                </p>
              </div>
