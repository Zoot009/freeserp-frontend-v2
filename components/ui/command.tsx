...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        // bg-muted, NOT the upstream bg-accent/text-accent-foreground. This
        // theme deliberately repurposes --accent as the BRAND blue (see the
        // mapping note in globals.css and the same fix in skeleton.tsx), so the
        // stock highlight painted every hovered row solid electric blue with
        // near-invisible text. Re-apply this if `shadcn add command` ever
        // overwrites the file.
